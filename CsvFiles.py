...
caminho = "TAXA_CAMBIO_HISTORICO.csv"
...
arquivo = "analise_mediana_mensal.csv"
analise_mediana_mensal = pd.read_csv(arquivo, sep=",", parse_dates=["Data de Referência"])

# analise_mediana_mensal = pd.read_csv("analise_mediana_mensal.csv", parse_dates=["Data de Referência"])


arquivo = "analise_precipitacao_mensal.csv"
analise_precipitacao_mensal = pd.read_csv(arquivo, sep=",", parse_dates=["Data de Referência"])
